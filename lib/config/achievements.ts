...
export const ACHIEVEMENTS: AchievementBadge[] = [
  ...
  {
    id: 'ach_recruiter_fav',
    category: 'career',
    title: 'Recruiter Favorite',
    description: 'Saved by 3 verified corporate recruiters in Recruiter Discovery.',
    iconName: 'Bookmark',
    xpValue: 220,
    rarity: 'Legendary',
    requiredCount: 3,
  ...
  {
    id: 'ach_interview_champ',
    category: 'practice',
    title: 'Interview Champion',
    description: 'Score 90%+ in 3 AI Technical Interview Lab simulations.',
    iconName: 'Video',
    xpValue: 250,
    rarity: 'Legendary',
    requiredCount: 3,
  ...
  {
    id: 'ach_analytics_master',
    category: 'learning',
    title: 'Analytics Master',
    description: 'Achieve Level 10 Analyst rank with 5,000+ total XP.',
    iconName: 'Trophy',
    xpValue: 500,
    rarity: 'Legendary',
    requiredCount: 1,
